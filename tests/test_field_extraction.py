...
from bank_api_parser.parsers.base_parser import BaseParser, APIMethod, ParseSnapshot
...
def test_fields_are_not_truncated():
    # A cap would drop the tail when a field is inserted mid-schema → false "field removed".
...
def test_sber_yaml_control_char_strip():
    ...
    from bank_api_parser.parsers.sber_parser import SberParser
